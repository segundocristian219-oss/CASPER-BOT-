...
const handler = async (m, { conn, participants }) => {
    ...
    // === fkontak con icono ===
    const res = await fetch('https://files.catbox.moe/jfdq8s.jpg');
